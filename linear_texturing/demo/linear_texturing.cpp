#include "linear_texturing.h"

namespace demo {
	void LinearTexturing::UpdateAndRender(spn::Canvas* canvas) {
	...
	void LinearTexturing::HandleInput(const SDL_Event* sdlEvent) {
	...
	void LinearTexturing::LoadModel() {
	...
	void LinearTexturing::Init(spn::SpinachCore* sc){
		spinachCore = sc;
