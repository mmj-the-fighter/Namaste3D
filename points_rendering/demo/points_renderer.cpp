...
namespace demo {
	void PointsRenderer::UpdateAndRender(spn::Canvas* canvas) {
	...
	void PointsRenderer::HandleInput(const SDL_Event* sdlEvent) {
	...
	void PointsRenderer::Init(spn::SpinachCore* sc) {
		spinachCore = sc;
