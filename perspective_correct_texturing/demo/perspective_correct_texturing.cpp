#include "perspective_correct_texturing.h"

namespace demo {
	void PerspectiveCorrectTexturing::UpdateAndRender(spn::Canvas* canvas) {
	...
	void PerspectiveCorrectTexturing::HandleInput(const SDL_Event* sdlEvent) {
	...
	void PerspectiveCorrectTexturing::LoadModel() {
	...
	void PerspectiveCorrectTexturing::Init(spn::SpinachCore* sc){
		spinachCore = sc;
