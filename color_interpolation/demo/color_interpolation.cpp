...
namespace demo {
	void ColorInterpolation::UpdateAndRender(spn::Canvas* canvas) {
	...
	void ColorInterpolation::HandleInput(const SDL_Event* sdlEvent) {
	...
	void ColorInterpolation::LoadModel() {
	...
	void ColorInterpolation::Init(spn::SpinachCore* sc){
		spinachCore = sc;
