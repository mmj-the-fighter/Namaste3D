#include "solid_color_renderer.h"

namespace demo {
	void SolidColorRenderer::UpdateAndRender(spn::Canvas* canvas) {
	...
	void SolidColorRenderer::HandleInput(const SDL_Event* sdlEvent) {
	...
	void SolidColorRenderer::LoadModel() {
	...
	void SolidColorRenderer::Init(spn::SpinachCore* sc){
		spinachCore = sc;
